...
<head>
    ...
    <!-- Fav Icon  --> --}}
    <link rel="shortcut icon" href="{{ asset('admin/src/images/favicon.png') }}">
    <!-- Page Title  -->
    <title>{{ $title }}</title>
    <!-- StyleSheets  -->
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="{{url('/')}}" class="logo-link">
                                <img class="mb-2" src="{{ asset(url('/') . $config->logo) }}">

                                <h6 class="text-center">LAYANAN PINJAM ASET KAB. BARITO TIMUR</h6>
                            </a>
                        </div>
                        @if (session('success'))
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="nk-block-content text-center text-lg-left">
                                        <p class="text-soft">&copy; {{ $config->pemda }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>

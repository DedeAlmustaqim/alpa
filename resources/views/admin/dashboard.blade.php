    ...
    <div class="row">
            ...
            <div class="card-inner">
                <div class="card-title-group align-start pb-3 g-2">
                    <div class="card-title">
                        <h6 class="title">Informasi Aset</h6>
                    </div>
                    <div class="card-tools">
                        <em class="card-hint icon ni ni-help" data-toggle="tooltip" data-bs-placement="left"
                            title="Infor asi Aset"></em>
                    </div>
                </div>
                <div class="analytic-au">
                    <div class="analytic-data-group analytic-au-group g-3">
                        <div class="analytic-data analytic-au-data">
                            <div class="title">Aset dipinjam</div>
                            <div class="amount">{{ $countStatus1 }} Aset</div>
                        </div>
                        <div class="analytic-data analytic-au-data">
                            <div class="title">Aset tidak dipinjam</div>
                            <div class="amount">{{ $countStatus0 }} Aset</div>
                        </div>
                        <div class="analytic-data analytic-au-data">
                            <div class="title">Total Aset</div>
                            <div class="amount">{{ $totalAset }} Aset</div>
                        </div>
                    </div>
        ...
        <div class="card">
            <div class="card-inner">
                <div class="card-title-group align-start pb-3 g-2">
                    <div class="card-title">
                        <h6 class="title">Informasi Permohonan</h6>
                    </div>
                    <div class="card-tools">
                        <em class="card-hint icon ni ni-help" data-toggle="tooltip" data-bs-placement="left"
                            title="Infor asi Aset"></em>
                ...
                <div class="analytic-au">
                    <div class="analytic-data-group analytic-au-group g-3">
                        <div class="analytic-data analytic-au-data">
                            <div class="title">Sedang dimohon</div>
                            <div class="amount">{{ $countMohon0 }} Permohonan</div>
                        </div>
                        <div class="analytic-data analytic-au-data">
                            <div class="title">Disetujui</div>
                            <div class="amount">{{ $countMohon1 }} Permohonan</div>
                        </div>
                        <div class="analytic-data analytic-au-data">
                            <div class="title">Selesai</div>
                            <div class="amount">{{ $countMohon2 }} Permohonan</div>
                        </div>
                        <div class="analytic-data analytic-au-data">
                            <div class="title">Ditolak</div>
                            <div class="amount">{{ $countMohon3 }} Permohonan</div>
                        </div>
                        <div class="analytic-data analytic-au-data">
                            <div class="title">Total</div>
                            <div class="amount">{{ $totalMohon }} Permohonan</div>
                        </div>
                    </div>
            ...
            ! function(NioApp, $) {
                ...
                var salesOverview = {
                    ...
                    datasets: [{
                        ...
                        data: [8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690,
                                    ...
                                    tooltip: {
                                        ...
                                        callbacks: {
                                            label: function label(context) {
                                                return "".concat(context.parsed.y, " ").concat(
                                                    _get_data.dataUnit);
                                            }
                                        },
                ...
                var analyticOvData = {
                    labels: ["01 Jan", "02 Jan", "03 Jan", "04 Jan", "05 Jan", "06 Jan", "07 Jan", "08 Jan",
                        "09 Jan", "10 Jan", "11 Jan", "12 Jan", "13 Jan", "14 Jan", "15 Jan", "16 Jan",
                        "17 Jan", "18 Jan", "19 Jan", "20 Jan", "21 Jan", "22 Jan", "23 Jan", "24 Jan",
                ...
                var analyticAuData = {
                    ...
                    datasets: [{
                        ...
                        color: "#9cabff",
                        background: "#9cabff",
                        data: [1110, 1220, 1310, 980, 900, 770, 1060, 830, 690, 730, 790, 950, 1100,
                            ...
                            options: {
                                plugins: {
                                    ...
                                    tooltip: {
                                        ...
                                        callbacks: {
                                            label: function label(context) {
                                                return "".concat(context.parsed, " ").concat(
                                                    _get_data.dataUnit);
                                            }
                                        },
                                        backgroundColor: '#fff',
                ...
                var totalDeposit = {
                    ...
                    datasets: [{
                        label: "Active User",
                        color: [NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp
                            .hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB(
                                "#6576ff", .2), NioApp.hexRGB("#6576ff", .2), "#6576ff"
                        ],
                        // @v2.0
                ...
                var orderOverview = {
                    labels: ["19 Dec", "20 Dec", "21 Dec", "22 Dec", "23 Dec", "24 Dec", "25 Dec", "26 Dec",
                        "27 Dec", "28 Dec", "29 Dec", "30 Dec", "31 Dec", "01 Jan"
                    ],
                    dataUnit: 'USD',
                    datasets: [{
                        label: "Buy Orders",
                        color: "#8feac5",
                        data: [1740, 2500, 1820, 1200, 1600, 2500, 1820, 1200, 1700, 1820, 1400, 1600,
                            1930, 2100
                        ]
                    }, {
                        label: "Sell Orders",
                        color: "#9cabff",
                        data: [2420, 1820, 3000, 5000, 2450, 1820, 2700, 5000, 2400, 2600, 4000, 2380,
                            2120, 1700
                        ]
                    }]
                };
                ...
                var userActivity = {
                    labels: ["01 Nov", "02 Nov", "03 Nov", "04 Nov", "05 Nov", "06 Nov", "07 Nov", "08 Nov",
                    ...
                    datasets: [{
                        label: "Direct Join",
                        color: "#9cabff",
                        data: [110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90, 110, 80, 125,
                            55, 95, 75, 90
                        ]
                    }, {
                        label: "Referral Join",
                        color: NioApp.hexRGB("#9cabff", .4),
                        data: [125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90, 110, 80, 125, 55, 95,
                            75, 90, 75, 90
                        ]
                    }]
                };
